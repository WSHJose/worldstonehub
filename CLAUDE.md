...
```css
--gold: #a67c52 /* principal */ --elite: #c9a84c
  /* gold alt / elite / estrellas */ --bg-soft: #f8f7f5 --bg: #ffffff
  --bg-mid: #f0efed --ink: #1a1917 /* dark */ --ink-2: #4a4845 --ink-4: #8a8784
  /* muted */ --border: #e2e0dc --border2: #c8c5bf --green: #27ae60
  /* status activo */;
```
