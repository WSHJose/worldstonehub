...
(function (window) {
  ...
  var LANGS = {
    ...
    es: {
      nav: {
        ...
        acceso: 'Acceso',
        miPanel: 'Mi Panel',
        mapaAriaLabel: 'Mapa Mundial de Canteras',
      ...
      /* ── Mapa ── */
      mapa: {
        titulo: 'Mapa Mundial de Canteras',
        subtitulo: 'Directorio mundial',
        buscar: 'Buscar cantera o material',
        placeholderMapa: 'Carrara, Granito, Blanco...',
        limpiar: '✕',
        filtros: {
          tipoPiedra: 'Tipo de piedra',
          color: 'Color predominante',
          pais: 'País de origen',
          relevancia: 'Relevancia histórica',
          limpiar: 'Limpiar',
        },
        canteras: 'canteras',
        enDirectorio: 'en el directorio',
      },
      ...
      state: {
        ...
        errorSub: 'Inténtalo de nuevo en unos momentos',
      ...
      footer: {
        tagline:
          'El portal internacional de referencia para todos los profesionales del sector de la piedra natural y artificial.',
        ...
        links: {
          canteras: 'Canteras del mundo',
          mapa: 'Mapa de canteras',
          materiales: 'Materiales',
          directorio: 'Directorio',
          publicar: 'Publicar mi empresa',
          planes: 'Planes y precios',
          reclamar: 'Reclamar cantera',
          sobre: 'Sobre World Stone Hub',
          contacto: 'Contacto',
          blog: 'Blog del sector',
          legal: 'Aviso legal',
        },
      ...
      nosotros: {
        ...
        stats: {
          ...
          sectores: 'Sectores cubiertos',
          directorio: 'Directorio verificado',
        ...
        mision: {
          ...
          p3strong:
            'hacer que el comercio global de piedra natural sea más accesible, más transparente y más eficiente',
        ...
        origen: {
          ...
          p3prefix:
            'WSH es un proyecto independiente, construido con rigor y sin inversores externos. Cada decisión de diseño, cada línea de código y cada perfil publicado responde a una misma convicción: ',
      ...
      contacto: {
        ...
        form: {
          ...
          asunto: 'Asunto *',
          asuntoPh: 'Selecciona un asunto',
          mensaje: 'Mensaje *',
          mensajePh: 'Cuéntanos en qué podemos ayudarte...',
        ...
        info: {
          ...
          emailDetail:
            'Bandeja revisada cada día laborable. Para consultas urgentes sobre publicación de empresa usa el formulario con asunto "Quiero publicar mi empresa".',
          ...
          publicarDesc:
            'Si quieres publicar tu empresa en el directorio, puedes empezar directamente desde el formulario de registro o escribirnos para que te guiemos.',
      ...
      index: {
        hero: {
          ...
          stat1: 'Canteras registradas',
          stat2: 'Tipos de piedra',
          stat3: 'Países cubiertos',
          stat4: 'Empresas en directorio',
        },
        search: {
          ...
          titleSuf: ' perfecto',
          subtitle:
            '200 materiales · 180 canteras · 7 empresas en directorio · todo en tiempo real',
          esc: 'ESC para cerrar',
          pillTodos: 'Todos',
          pillMateriales: 'Materiales',
          pillCanteras: 'Canteras',
          pillProveedores: 'Proveedores',
          resultsHint: 'Haz clic para ir a la ficha completa',
          verMas: 'Ver más resultados',
        ...
        professionals: {
          ...
          c1: {
            title: 'Propietarios de canteras',
            desc: 'Extractores y productores de piedra natural en origen, con fichas técnicas, capacidad y certificaciones.',
            link: 'Ver canteras →',
          },
          c2: {
            title: 'Distribuidores',
            desc: 'Red de distribución internacional que conecta productores con arquitectos, interioristas y constructores.',
            link: 'Ver distribuidores →',
          },
          c3: {
            title: 'Fabricantes y talleres',
            desc: 'Serrerías, talleres y fábricas que transforman el bloque en producto acabado para obra e interiorismo.',
            link: 'Ver fabricantes →',
          },
          c4: {
            title: 'Estudios de arquitectura',
            desc: 'Estudios que prescriben y especifican piedra natural en proyectos residenciales, hoteleros y comerciales.',
            link: 'Ver estudios →',
          },
          c5: {
            title: 'Constructoras',
            desc: 'Empresas constructoras e instaladoras que trabajan con piedra natural en proyectos de cualquier escala.',
            link: 'Ver constructoras →',
          },
          c6: {
            title: 'Maquinaria industrial',
            desc: 'Fabricantes y distribuidores de maquinaria especializada en extracción, corte y transformación de piedra.',
            link: 'Ver maquinaria →',
          },
          c7: {
            title: 'Laboratorios y certificación',
            desc: 'Laboratorios de ensayo, organismos de certificación y entidades normativas del sector de la piedra.',
            link: 'Ver laboratorios →',
          },
          c8: {
            title: 'Logística',
            desc: 'Operadores logísticos, transportistas y agentes de aduanas especializados en el movimiento de piedra natural.',
            link: 'Ver logística →',
          },
        },
        quarries: {
          ...
          feat1Desc:
            'Absorción, densidad, resistencia al desgaste y acabados disponibles para cada tipo de piedra.',
          feat2Title: 'Galería de muestras fotográficas',
          feat2Desc:
            'Imágenes de alta resolución de losas, bloques y aplicaciones reales en proyectos.',
          feat3Title: 'Contacto directo verificado',
          feat3Desc:
            'Datos de contacto comprobados, con posibilidad de solicitar muestras desde la ficha.',
          feat4Title: 'Filtros avanzados de búsqueda',
          feat4Desc:
            'Por país, tipo de roca, color, uso recomendado, certificaciones y disponibilidad.',
        ...
        membership: {
          ...
          badge: 'Más popular',
          presencia: {
            f1: 'Ficha básica verificada',
            f2: 'Aparición en búsquedas',
            f3: 'Hasta 10 fotos de catálogo',
            f4: 'Datos de contacto visibles',
            f5: 'Estadísticas básicas de visitas',
            btn: 'Empezar →',
          },
          profesional: {
            f1: 'Ficha premium destacada',
            f2: 'Posicionamiento prioritario',
            f3: 'Catálogo ilimitado de productos',
            f4: 'Galería de proyectos realizados',
            f5: 'Formulario de solicitud de muestras',
            f6: 'Estadísticas avanzadas + leads',
            f7: 'Badge verificado de confianza',
            btn: 'Empezar ahora →',
          },
          elite: {
            f1: 'Todo lo del plan Profesional',
            f2: 'Posición destacada en homepage',
            f3: 'Artículos editoriales del sector',
            f4: 'Integración de catálogo API/feed',
            f5: 'Múltiples usuarios del panel',
            f6: 'Gestor de cuenta dedicado',
            f7: 'Informes mensuales de mercado',
            btn: 'Contactar →',
          },
        },
      },
      ...
      proveedores: {
        ...
        planPresencia: 'Presencia',
        sectorFabricantes: 'Fabricantes',
        sectorDistribuidores: 'Distribuidores',
        sectorExportadores: 'Exportadores',
        sectorImportadores: 'Importadores',
        limpiar: 'Limpiar',
        statVerificados: 'Verificados',
        descHTML:
          'Empresas del sector de la piedra natural con perfil verificado. Los perfiles <strong style="color:var(--gold);font-weight:500;">Elite</strong> y <strong style="color:var(--gold);font-weight:500;">Profesional</strong> incluyen ficha completa, materiales, certificaciones y contacto directo.',
      },
    ...
    en: {
      nav: {
        ...
        acceso: 'Sign In',
        miPanel: 'My Panel',
        mapaAriaLabel: 'World Quarry Map',
        todosProveedores: 'All providers',
      ...
      /* ── Mapa ── */
      mapa: {
        titulo: 'World Quarry Map',
        subtitulo: 'World directory',
        buscar: 'Search quarry or material',
        placeholderMapa: 'Carrara, Granite, White...',
        limpiar: '✕',
        filtros: {
          tipoPiedra: 'Stone type',
          color: 'Primary colour',
          pais: 'Country of origin',
          relevancia: 'Historical relevance',
          limpiar: 'Clear',
        },
        canteras: 'quarries',
        enDirectorio: 'in the directory',
      },

      /* ── State messages ── */
      state: {
        cargando: 'Loading...',
        cargandoFicha: 'Loading profile…',
      ...
      footer: {
        tagline:
          'The global reference platform for all professionals in the natural and engineered stone industry.',
        ...
        links: {
          canteras: 'World quarry directory',
          mapa: 'Quarry map',
          materiales: 'Materials',
          directorio: 'Directory',
          publicar: 'List your company',
      ...
      nosotros: {
        ...
        stats: {
          paises: 'Countries represented',
          sectores: 'Sectors covered',
          directorio: 'Verified directory',
        ...
        mision: {
          ...
          p3strong:
            'make global trade in natural stone more accessible, more transparent and more efficient',
        ...
        origen: {
          ...
          p3prefix:
            'WSH is an independent project, built with rigour and without external investors. Every design decision, every line of code and every published profile responds to a single conviction: ',
      ...
      contacto: {
        ...
        info: {
          ...
          emailDetail:
            'Inbox reviewed every working day. For urgent company listing queries use the form with subject "I want to list my company".',
          responseLabel: 'Response time',
          responseVal: 'Less than 24 hours on working days.',
          ubicacionLabel: 'Location',
          publicarLabel: 'I want to list my company',
          publicarDesc:
            'If you want to list your company in the directory, you can start directly from the registration form or write to us for guidance.',
      ...
      index: {
        hero: {
          ...
          stat1: 'Registered quarries',
          stat2: 'Stone types',
          stat3: 'Countries covered',
          stat4: 'Companies in directory',
        },
        search: {
          ...
          esc: 'ESC to close',
          pillTodos: 'All',
          pillMateriales: 'Materials',
          pillCanteras: 'Quarries',
          pillProveedores: 'Providers',
          resultsHint: 'Click to view full profile',
          verMas: 'View more results',
          sinResultados: 'No results',
        ...
        professionals: {
          ...
          c1: {
            title: 'Quarry owners',
            desc: 'Extractors and producers of natural stone at source, with technical data sheets, capacity and certifications.',
            link: 'View quarries →',
          },
          c2: {
            title: 'Distributors',
            desc: 'International distribution network connecting producers with architects, interior designers and construction firms.',
            link: 'View distributors →',
          },
          c3: {
            title: 'Manufacturers & workshops',
            desc: 'Sawmills, workshops and factories that transform blocks into finished products for construction and interior design.',
            link: 'View manufacturers →',
          },
          c4: {
            title: 'Architecture studios',
            desc: 'Studios that prescribe and specify natural stone in residential, hospitality and commercial projects.',
            link: 'View studios →',
          },
          c5: {
            title: 'Construction firms',
            desc: 'Construction and installation companies working with natural stone in projects of any scale.',
            link: 'View construction →',
          },
          c6: {
            title: 'Industrial machinery',
            desc: 'Manufacturers and distributors of machinery specialised in extraction, cutting and processing of stone.',
            link: 'View machinery →',
          },
          c7: {
            title: 'Laboratories & certification',
            desc: 'Testing laboratories, certification bodies and regulatory entities in the natural stone sector.',
            link: 'View laboratories →',
          },
          c8: {
            title: 'Logistics',
            desc: 'Logistics operators, carriers and customs agents specialised in the movement of natural stone.',
            link: 'View logistics →',
          },
        },
        quarries: {
          ...
          feat1Desc:
            'Absorption, density, wear resistance and available finishes for each stone type.',
          ...
          feat3Desc:
            'Verified contact details, with the option to request samples directly from the profile.',
          feat4Title: 'Advanced search filters',
          feat4Desc:
            'By country, rock type, colour, recommended use, certifications and availability.',
        ...
        membership: {
          ...
          badge: 'Most popular',
          presencia: {
            f1: 'Verified basic profile',
            f2: 'Appear in searches',
            f3: 'Up to 10 catalogue photos',
            f4: 'Visible contact details',
            f5: 'Basic visit statistics',
            btn: 'Get started →',
          },
          profesional: {
            f1: 'Featured premium profile',
            f2: 'Priority positioning',
            f3: 'Unlimited product catalogue',
            f4: 'Completed projects gallery',
            f5: 'Sample request form',
            f6: 'Advanced statistics + leads',
            f7: 'Verified trust badge',
            btn: 'Get started now →',
          },
          elite: {
            f1: 'Everything in Professional',
            f2: 'Featured position on homepage',
            f3: 'Industry editorial articles',
            f4: 'API/feed catalogue integration',
            f5: 'Multiple panel users',
            f6: 'Dedicated account manager',
            f7: 'Monthly market reports',
            btn: 'Contact us →',
          },
        },
      },
      ...
      proveedores: {
        ...
        planPresencia: 'Presence',
        sectorFabricantes: 'Manufacturers',
        sectorDistribuidores: 'Distributors',
        sectorExportadores: 'Exporters',
        sectorImportadores: 'Importers',
        limpiar: 'Clear',
        statVerificados: 'Verified',
        descHTML:
          'Verified natural stone industry companies. <strong style="color:var(--gold);font-weight:500;">Elite</strong> and <strong style="color:var(--gold);font-weight:500;">Professional</strong> profiles include full data sheet, materials, certifications and direct contact.',
      },
  ...
  function _applyIn(root) {
    ...
    for (var j = 0; j < htmlEls.length; j++) {
      var hel = htmlEls[j],
        hkey = hel.getAttribute('data-i18n-html'),
        hval = t(hkey);
    ...
    for (var k = 0; k < attrEls.length; k++) {
      var ael = attrEls[k],
        pairs = ael.getAttribute('data-i18n-attr').split(',');
      for (var p = 0; p < pairs.length; p++) {
        var pair = pairs[p].trim().split(':');
        if (pair.length < 2) continue;
        var attr = pair[0].trim(),
          akey = pair.slice(1).join(':').trim(),
          aval = t(akey);
  ...
  function _syncSelector(lang) {
    ...
    for (var i = 0; i < btns.length; i++) {
      var btn = btns[i],
        active = btn.getAttribute('data-lang') === lang;
  ...
  function setLang(lang) {
    ...
    try {
      document.dispatchEvent(
        new CustomEvent('wsh:langchange', {
          detail: { lang: lang },
          bubbles: false,
        })
      );
  ...
  function init() {
    ...
    var lang =
      stored && SUPPORTED.indexOf(stored) !== -1
        ? stored
        : SUPPORTED.indexOf(browser) !== -1
          ? browser
          : DEFAULT_LANG;
    setLang(lang);
  }
